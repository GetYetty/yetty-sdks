...
import type { TokenManager } from './interfaces.js';
import { consoleLogger, type ZohoBooksLogger } from './logger.js';
import type { ZohoBooksRegion, ZohoBooksTokenResponse } from './types.js';
...
export class ZohoBooksTokenManager implements TokenManager {
  ...
  async getAccessToken(): Promise<string> {
    if (
      ...
      this.tokenExpiresAt - EXPIRY_BUFFER_MS > Date.now()
    ) {
