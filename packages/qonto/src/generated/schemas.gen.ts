...
export const ResultSchema = {
  type: 'object',
  required: ['client_transfer_id', 'transfer_id', 'errors', 'status'],
  properties: {
    client_transfer_id: {
      type: 'string',
      format: 'uuid',
...
export const PaginationSchema = {
  ...
  required: ['current_page', 'next_page', 'prev_page', 'total_pages', 'total_count', 'per_page'],
  properties: {
    current_page: {
      type: 'integer',
...
export const BulkTransferRequestSchema = {
  type: 'object',
  required: ['amount', 'client_transfer_id', 'reference'],
  properties: {
    beneficiary_id: {
      type: 'string',
      format: 'uuid',
...
export const BulkSepaTransferRequestSchema = {
  type: 'object',
  required: ['bank_account_id', 'bulk_transfers', 'vop_proof_token'],
  properties: {
    vop_proof_token: {
      type: 'string',
      description:
...
export const CreateSepaTransferRequestSchema = {
  type: 'object',
  required: ['transfer', 'vop_proof_token'],
  properties: {
    vop_proof_token: {
      type: 'string',
      description:
    ...
    transfer: {
      type: 'object',
      required: ['bank_account_id', 'reference', 'amount'],
      properties: {
        beneficiary_id: {
          type: 'string',
          format: 'uuid',
...
export const BulkSingleRequestSchema = {
  type: 'object',
  required: ['id', 'beneficiary_name', 'iban'],
  properties: {
    id: {
      type: 'string',
      description:
    ...
    },
    {
      ...
      properties: {
        code: {
          ...
          enum: ['INTERNAL_SERVER_ERROR_UNSPECIFIED', 'INTERNAL_SERVER_ERROR_4XX_RESPONDING_BANK'],
        },
        status: {
          enum: ['500'],
        },
    ...
    },
    {
      ...
      properties: {
        code: {
          ...
          enum: ['GATEWAY_TIMEOUT_ERROR_UNSPECIFIED', 'GATEWAY_TIMEOUT_ERROR_RESPONDING_BANK'],
        },
        status: {
          enum: ['504'],
        },
...
export const CreateSepaRecurringTransferRequestSchema = {
  type: 'object',
  required: ['recurring_transfer', 'vop_proof_token'],
  properties: {
    vop_proof_token: {
      type: 'string',
      description:
    ...
    recurring_transfer: {
      type: 'object',
      required: ['bank_account_id', 'reference', 'amount', 'frequency', 'first_execution_date'],
      properties: {
        beneficiary_id: {
          type: 'string',
          format: 'uuid',
...
export const BankAccountSchema = {
  type: 'object',
  required: ['id', 'name', 'organization_id', 'status', 'main'],
  properties: {
    id: {
      type: 'string',
      format: 'uuid',
...
export const BeneficiarySchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['pending', 'declined', 'validated'],
      description:
  ...
  required: ['id', 'name', 'status', 'trusted', 'created_at', 'updated_at'],
} as const;
...
export const MembershipSchema = {
  ...
  properties: {
    ...
    role: {
      type: 'string',
      enum: ['owner', 'admin', 'manager', 'reporting', 'employee'],
...
export const SepaBeneficiarySchema = {
  ...
  required: ['id', 'name', 'iban', 'bic', 'status', 'trusted', 'created_at', 'updated_at'],
} as const;
...
export const SupplierInvoiceStatusSchema = {
  ...
  oneOf: [
    ...
    },
    {
      const: 'to_approve',
      description:
        'Invoice has been assigned an approval workflow and requires approval before payment.',
    },
    {
    ...
    },
    {
      const: 'pending',
      description:
        'Invoices that have been requested for payment by users who lack the necessary payment permissions.',
    },
    {
      const: 'scheduled',
      description:
        'Invoice payment has been scheduled but not yet executed. Payment is queued and will be automatically processed at the scheduled time.',
    },
    {
      const: 'paid',
    ...
    },
    {
      const: 'archived',
      description:
        'Invoice has been moved to archive for record-keeping purposes. Can be accessed and unarchived if needed.',
    },
    {
      const: 'rejected',
...
export const EInvoicingLifecycleEventStatusCodeSchema = {
  type: 'integer',
  enum: [200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214],
  description:
...
export const SupplierInvoiceSchema = {
  ...
  properties: {
    ...
    source_type: {
      type: 'string',
      example: 'email',
      enum: ['email', 'e_invoicing', 'direct_upload'],
    },
    source: {
      type: 'string',
        ...
        reasons: {
          ...
          properties: {
            ...
            delete: {
              ...
              items: {
                type: 'string',
                enum: ['invalid_status', 'linked_self_invoice', 'is_recorded'],
              },
    ...
    approval_workflow: {
      ...
      required: ['approver_ids', 'supplier_invoice_request_id', 'verified_by', 'last_approved_by'],
    },
    payable_amount: {
      type: 'object',
      nullable: true,
...
export const ClientInvoiceSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['draft', 'unpaid', 'paid', 'canceled'],
      example: 'paid',
    },
    invoice_url: {
      type: 'string',
    ...
    einvoicing_status: {
      type: 'string',
      enum: ['pending', 'submitted', 'declined', 'approved', 'not_delivered', 'submission_failed'],
    },
    welfare_fund: {
      type: 'object',
      properties: {
...
export const InvoiceSettingsOverrideSchema = {
  ...
  properties: {
    ...
    vat_payment_condition: {
      type: 'string',
      enum: ['on_receipts', 'compensated_for_sales'],
      example: 'on_receipts',
    },
    discount_conditions: {
      type: 'string',
...
export const DocumentItemPayloadSchema = {
  ...
  required: ['title', 'quantity', 'unit_price', 'vat_rate'],
} as const;
...
export const ClientInvoiceCreatePayloadSchema = {
  ...
  properties: {
    ...
    withholding_tax: {
      ...
      required: ['reason', 'rate', 'payment_reason'],
    },
    stamp_duty_amount: {
      type: 'string',
      description:
  ...
  required: ['client_id', 'issue_date', 'due_date', 'currency', 'payment_methods', 'items'],
} as const;
...
export const QuoteSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['pending_approval', 'approved', 'canceled'],
...
export const QuoteCreatePayloadSchema = {
  type: 'object',
  required: ['issue_date', 'expiry_date', 'terms_and_conditions', 'currency', 'client_id', 'items'],
  properties: {
    client_id: {
      type: 'string',
      format: 'uuid',
    ...
    items: {
      ...
      items: {
        type: 'object',
        required: ['title', 'currency', 'quantity', 'unit_price', 'vat_rate'],
        properties: {
          title: {
            type: 'string',
            description: 'Item title',
...
export const ClientCompanySchema = {
  ...
  properties: {
    ...
    extra_emails: {
      ...
      maxItems: 100,
      example: ['additional@email.com', 'backup@email.com'],
    },
    currency: {
      type: 'string',
...
export const ClientIndividualCreatePayloadSchema = {
  ...
  required: ['first_name', 'last_name', 'kind'],
} as const;
...
export const StatementSchema = {
  ...
  properties: {
    ...
    file: {
      ...
      required: ['file_name', 'file_content_type', 'file_size', 'file_url'],
    },
  },
  required: ['id', 'bank_account_id', 'period', 'file'],
  'x-examples': {
    'Example 1': {
...
export const InsuranceContractPartnerDataSchema = {
  ...
  properties: {
    ...
    origin: {
      type: 'string',
      enum: ['insurance_hub', 'qonto_other', 'stello'],
    ...
    payment_frequency: {
      type: 'string',
      enum: ['month', 'quarter', 'semester', 'annual'],
...
export const card_categoriesSchema = {
  ...
  example: ['transport', 'restaurant_and_bar', 'food_and_grocery'],
} as const;
...
export const CardAssetsSchema = {
  ...
  required: ['front_large', 'front_small', 'front_small_wallet'],
} as const;
...
export const CreateAdvertisingCardSchema = {
  ...
  properties: {
    card: {
      ...
      required: ['holder_id', 'organization_id', 'bank_account_id', 'card_level'],
    },
  },
} as const;
...
export const PhysicalCardWithOptionsSchema = {
  ...
  properties: {
    card: {
      ...
      required: ['atm_option', 'nfc_option', 'online_option', 'foreign_option'],
    },
  },
  required: ['card'],
} as const;
...
export const InternationalEligibilityPayloadSchema = {
  ...
  properties: {
    ...
    reason: {
      type: 'string',
      enum: ['flex_kyb_not_approved', 'kyb_not_approved', 'unknown'],
      description:
  ...
  properties: {
    currencies: {
      ...
      items: {
        ...
        required: ['currency_code', 'country_code'],
      },
    },
  },
  required: ['currencies'],
...
export const InternationalQuotePayloadSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['PENDING', 'FUNDED', 'EXPIRED', 'ACCEPTED'],
              ...
              properties: {
                ...
                group: {
                  ...
                  items: {
                    ...
                    required: ['key', 'name', 'type', 'refresh_requirements_on_change', 'required'],
                  },
                },
              },
              required: ['name', 'group'],
...
export const InternationalBeneficiaryPayloadSchema = {
  ...
  required: ['id', 'name', 'country', 'currency', 'payment_type', 'account_identifier'],
} as const;
...
export const CreateInternationalBeneficiaryRequestSchema = {
  ...
  properties: {
    ...
    payload: {
      ...
      required: ['currency', 'type', 'details'],
    },
  },
  required: ['quote_id', 'payload'],
} as const;
...
export const CreateInternationalTransferRequestSchema = {
  ...
  properties: {
    ...
    attachment_ids: {
      ...
      example: ['0196edb0-9b6e-7554-9864-d111285a0a40'],
    },
    details: {
      type: 'object',
      description:
...
export const InternationalTransferPayloadSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['PROCESSING', 'CANCELED', 'DECLINED', 'SETTLED', 'RETURNED'],
...
export const ListInternationalTransferRequirementsRequestSchema = {
  ...
  required: ['quote_id', 'target_account_id', 'details'],
} as const;
...
export const PaymentLinkConnectionSchema = {
  type: 'object',
  required: ['connection_location', 'status', 'bank_account_id'],
  properties: {
    connection_location: {
      type: 'string',
    ...
    status: {
      type: 'string',
      enum: ['enabled', 'pending', 'disabled', 'not_connected'],
      description:
...
export const PaymentLinkSchema = {
  ...
  properties: {
    ...
    potential_payment_methods: {
      ...
      items: {
        type: 'string',
        enum: ['credit_card', 'apple_pay', 'paypal', 'ideal'],
        example: 'credit_card',
      },
    },
    amount: {
...
export const CreatePaymentLinkRequestSchema = {
  ...
  properties: {
    payment_link: {
      type: 'object',
      required: ['potential_payment_methods', 'reusable', 'items'],
      properties: {
        potential_payment_methods: {
          type: 'array',
...
export const PaymentLinkPaymentSchema = {
  type: 'object',
  required: ['id', 'amount', 'status', 'created_at', 'payment_method', 'paid_at', 'debitor_email'],
  properties: {
    id: {
      type: 'string',
      format: 'uuid',
    ...
    status: {
      ...
      enum: ['open', 'pending', 'authorized', 'paid', 'canceled', 'expired', 'failed'],
      example: 'open',
    },
    created_at: {
      type: 'string',
...
export const ListPaymentLinkPaymentMethodsResponseSchema = {
  type: 'object',
  required: ['payment_link_payment_methods'],
  properties: {
...
export const CreateEmbedAuthLinkRequestSchema = {
  type: 'object',
  required: ['embed_auth_link'],
  properties: {
    embed_auth_link: {
      type: 'object',
      required: ['post_authn_action'],
      properties: {
        post_authn_action: {
          type: 'string',
          enum: ['create_payment_link'],
          description:
...
export const EmbedAuthLinkSchema = {
  type: 'object',
  required: ['url', 'post_authn_action', 'callback_url', 'expired_at', 'used_at'],
  properties: {
    url: {
      type: 'string',
...
export const TransactionDataV1Schema = {
  ...
  properties: {
    ...
    check: {
      type: 'object',
      required: ['check_number', 'check_key'],
      properties: {
        check_number: {
          type: 'string',
    ...
    financing_installment: {
      type: 'object',
      required: ['total_installments_number', 'current_installment_number'],
      properties: {
        total_installments_number: {
          type: 'integer',
          description: 'Total number of installments',
    ...
    pagopa_payment: {
      type: 'object',
      required: ['notice_number', 'creditor_fiscal_code', 'iuv'],
      properties: {
        notice_number: {
          type: 'string',
...
export const AccountDataV1Schema = {
  ...
  required: ['event', 'id', 'status', 'main', 'iban', 'currency', 'authorized_balance'],
} as const;
...
export const OrganizationDataV1Schema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['kyb_waiting', 'activated', 'suspended', 'deactivated'],
...
export const PaymentLinkDataV1Schema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['open', 'processing', 'paid', 'canceled', 'expired'],
      description:
    ...
    potential_payment_methods: {
      ...
      example: ['credit_card', 'sepa_credit_transfer'],
    },
...
export const PaymentLinkConnectionDataV1Schema = {
  ...
  properties: {
    event: {
      type: 'string',
      enum: ['connection_enabled', 'connection_revoked'],
      description:
